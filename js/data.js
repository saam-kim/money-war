const ROLE_CARDS = [
  ...
  },
  {
    ...
    weakWhen: "해외 비용 증가",
    explanation: "공연, 음원, 영상 콘텐츠는 서비스 거래이자 문화 콘텐츠 거래로 볼 수 있습니다.",
    initialMoney: 115,
    initialStability: 53,
    initialRisk: 20,
    tradeType: "서비스 거래"
...
const ROUNDS = [
  ...
  },
  {
    ...
    concept: "수입 원자재는 재화 거래입니다. 원자재 가격과 환율이 함께 오르면 해외에서 사 오는 비용이 이중으로 커져 공장과 수입기업에 부담이 됩니다."
  },
  {
    title: "K-콘텐츠 해외 수출 증가",
    shortStatus: "콘텐츠 수출 증가",
    situation: "해외에서 한국 콘텐츠 수요가 늘고 달러 수입이 증가했습니다. 문화 콘텐츠도 국제 거래의 중요한 대상이 되고 있습니다.",
    teacherGuide: "국제 거래는 물건만이 아니라 공연, 관광, 교육 같은 서비스도 포함한다는 말로 마무리하세요.",
    discussionPrompt: "K-pop 공연과 영상 콘텐츠 판매는 왜 물건 수출이 아니라 서비스·콘텐츠 거래로 볼 수 있을까요?",
    ...
    choices: [
      {
        ...
        feedback: "해외 수요가 클 때 적극적으로 진출하면 수입이 늘 수 있지만 운영 위험도 커집니다."
      },
      {
      ...
      },
      {
        ...
        feedback: "해외 지사 설립은 자본 거래와 연결되며 신중한 판단이 필요합니다."
      }
    ],
    concept: "K-pop 공연과 콘텐츠 판매는 서비스 거래이자 문화 콘텐츠 거래입니다. 국제 거래에는 물건뿐 아니라 공연, 교육, 관광 같은 서비스도 포함됩니다."
  }
];
...
const TRADE_TYPES = [
  ...
  {
    title: "서비스 거래",
    text: "공연, 관광, 운송, 교육처럼 형태가 없는 서비스를 사고파는 거래입니다."
  },
  {
    title: "자본 거래",
